 ...
 */
public fun List<Annotation>.findQualifier(errorContext: () -> String): Annotation? {
 ...
 */
public class MultipleQualifierError(context: String) : AssertionError("Multiple qualifier annotations found: $context")
